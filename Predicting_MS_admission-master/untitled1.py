...
sns.pairplot(dataset, hue='admit',palette="husl", x_vars=["Internal","X gpa","rank"], y_vars=["internal","X gpa","rank"], size=4)
plt.show()
...
for i in range(no_of_test_cases):
	print("Status of Student with Internal = {}, X GPA grade = {}, Rank = {} will be ----- {}".format(new_data[i][0],new_data[i][1],new_data[i][2], labels[int(prediction[i])]))
